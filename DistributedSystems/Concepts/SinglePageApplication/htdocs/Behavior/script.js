...
function loadMainPage() {
    ...
    loadCSS('StyleSheets/WebProgramming.css', 'remove');
...
function loadWebProgrammingPage() {
    ...
    const url = '../Structure/WebProgramming.html'; // Correct URL to fetch the actual file
    ...
    fetch(url)
        ...
        .then(html => {
            ...
            loadCSS('../StyleSheets/WebProgramming.css', 'add');
        })
        .catch(error => {
